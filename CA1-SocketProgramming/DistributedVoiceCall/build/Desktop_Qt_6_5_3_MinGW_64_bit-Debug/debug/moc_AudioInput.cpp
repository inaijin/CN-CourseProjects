...
Q_CONSTINIT static const qt_meta_stringdata_CLASSAudioInputENDCLASS_t qt_meta_stringdata_CLASSAudioInputENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(11, 16),  // "encodedDataReady"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 4),  // "data"
        QT_MOC_LITERAL(34, 18)   // "processAudioBuffer"
    },
    "AudioInput",
    "encodedDataReady",
    "",
...
void AudioInput::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->processAudioBuffer(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &AudioInput::encodedDataReady; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AudioInput::encodedDataReady(const QByteArray & _t1)
{
